                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex no-print justify-content-between align-items-center">
                                    ...
                                    <div class="py-2">
                                        <a href="{{ url('admin-expense') }}" class="btn btn-primary">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <h4>
                                                ...
                                                <center>
                                                    <h2 class="mt-3"><b>Laporan Maklumat Perbelanjan</b></h2>
                                                </center>
                                            </h4>
                                                        ...
                                                        <td>
                                                            @if (count($categoriesWithSum) > 0)
                                                                @foreach ($categoriesWithSum as $index => $category)
                                                                    {{ $category['nama'] }}: RM
                                                                    {{ $category['expenses_sum_jumlah_tbj'] }}
                                                                    @if (!$loop->last)
                                                                        <br>
                                                                    @endif
                                                                @endforeach
                                                ...
                                                <tbody>
                                                    @forelse ($expense as $expense)
                                                        <tr>
                                                            ...
                                                            <td>{{ $expense->id_trax_perbelanjaan }}</td>
                                                            <td>{{ $expense->category->nama }}</td>
                                                            <td>RM {{ $expense->jumlah_tbj }}</td>
                                                            <td> @formatDate($expense->tarikh)</td>
