            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <div class="mr-auto">
                            <h5>Senarai Permohonan Yang Perlu Disahkan</h5>
                        </div>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <center>Tempoh Permohonan Diterima</center>
                                        </th>
                                        <th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <div class="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <span class="badge p-2 badge-pill {{ $badgeClass }}">
                                                        @if ($daysDifference > 0)
                                                            {{ $daysDifference }} hari yang lalu
                                                        @else
                                                            Diterima hari ini
                                                        @endif
                                                    </span>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <a href="{{ route('application-approval.edit', ['application' => $application->id_permohonan]) }}"
