                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex no-print justify-content-between align-items-center">
                                    ...
                                    <div class="py-2">
                                        <a href="{{ url('application-record') }}" class="btn btn-primary">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $jumlahPermohonan }} permohonan</td>
                                                    </tr>
                                                    <tr>
                                                        <td>2.</td>
                                                        <td>Jumlah Permohonan Dalam Proses</td>
                                                        <td>{{ $dalamProses }} permohonan
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>3.</td>
                                                        <td>Jumlah Permohonan Berjaya</td>
                                                        <td>{{ $berjaya }} permohonan<br>
                                        ...
                                        <div class="col-12 table-responsive">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    @empty
                                                        <td colspan="7" class="text-center">Tiada rekod anak jagaan
                                                        </td>
                                                    @endforelse
                                                </tbody>
                                            </table>
