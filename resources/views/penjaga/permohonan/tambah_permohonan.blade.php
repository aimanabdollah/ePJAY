            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        ...
                        <div class=""> <a href="{{ url('user-home') }}" class="btn btn-primary">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    class="form-control remove-error-on-input @error('nama_penuh_pemohon') is-invalid @enderror"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="hubungan_pemohon">Hubungan Anak dengan Pemohon<i
                                                        style="color: red">*</i></label>
                                                <input type="text"
                                                    class="form-control remove-error-on-input @error('hubungan_pemohon') is-invalid @enderror"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="pekerjaan_pemohon">Pekerjaan Pemohon<i
                                                        style="color: red">*</i></label>
                                                <input type="text"
                                                    class="form-control remove-error-on-input @error('pekerjaan_pemohon') is-invalid @enderror"
                                                    id="pekerjaan_pemohon" name="pekerjaan_pemohon"
                                                    value="{{ old('pekerjaan_pemohon') }}" placeholder="Masukkan Pekerjaan">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    class="form-control remove-error-on-input @error('email_pemohon') is-invalid @enderror"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    class="form-control remove-error-on-input @error('no_tel_pemohon') is-invalid @enderror"
                                                    id="no_tel_pemohon" name="no_tel_pemohon"
                                                    value="{{ old('no_tel_pemohon') }}" placeholder="Masukkan No Telefon">
                                            </div>
                                        </div>
                                    </div>
                                </div>
