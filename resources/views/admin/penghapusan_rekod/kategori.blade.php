                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <form
                                                        action="{{ route('record-delete.deleteCategory', ['category' => $category->id]) }}"
                                                    ...
                                                    <!-- For debugging purposes, print the generated URL -->
                                                    {{ route('record-delete.deleteCategory', ['category' => $category->id]) }}
